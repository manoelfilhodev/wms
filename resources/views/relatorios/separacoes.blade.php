...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <div>
            <a href="{{ route('relatorios.separacoes.excel', request()->query()) }}" class="btn btn-success btn-sm me-2">
                <i class="mdi mdi-file-excel"></i> Exportar Excel
            </a>
            <a href="{{ route('relatorios.separacoes.pdf', request()->query()) }}" class="btn btn-danger btn-sm">
