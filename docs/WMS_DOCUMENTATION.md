...
|--------|--------------|--------|
| **wms (Laravel)** | [github.com/manoelfilhodev/wms](https://github.com/manoelfilhodev/wms) | API REST + Painel Administrativo |
| **wms_app (Flutter)** | [github.com/manoelfilhodev/wms_app](https://github.com/manoelfilhodev/wms_app) | Aplicativo Mobile 
(Operacional) |
...
Abra um Pull Request detalhado para main.
🧼 Boas práticas
